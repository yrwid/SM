...
SoftwareSerial esp8266(2, 4); //rx, tx pins - esp jako klient atmegi
DHT dht;                      //inicjalizacja
String GET;                   //zmienna do get request (http protocol)

Adafruit_BMP085 bmp;		  //inicjalizacja bmp
...
int temperatura = 0;
int wilgotnosc = 0;
float temperature_p = 0, humidity_p = 0, pressure_p = 0, ppm=0;
String wilgotnosc_str, temperatura_str,temperatura2_str, cisnienie_str, ppm_str;
    esp8266.begin(115200);          //komunikacja esp - arduino bound rate
    esp8266.println("AT+CIPMUX=1"); //ustawienie trybu wielu polaczen
    delay(200);
...
void loop(){
  ...
  ppm = pow(1538.46*ratio, -1.709);           //na podstawie charakterystyki z dokumentacji
...
void updateDHT(String a, String b){
 ...
 command += "\r\n\r\n";
  esp8266.println("AT+CIPSTART=4,\"TCP\",\"192.168.43.85\",80"); //192.168.43.85 //rozpoczecie komunikacji z serwerem
  delay(500);//bylo 5000
  esp8266.print("AT+CIPSEND=4,");//wysylanie 4 kanal, dlugosc wiadomosci
  esp8266.println(command.length());  
  delay(300);
  esp8266.print(command); //wyslanie komendy
  delay(300);//bylo 3000
  esp8266.println("AT+CIPCLOSE=4");//zamykamy polaczenie
}
void updateBMP(String a, String b){
 ...
 command += "\r\n\r\n";
  esp8266.println("AT+CIPSTART=4,\"TCP\",\"192.168.43.85\",80");
  delay(500);
...
void connect_c(){
  esp8266.println("AT+CWMODE=1"); //tryb pracy esp - klient
  delay(2000);
